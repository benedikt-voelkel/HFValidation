 AliAnalysisTaskSELambdac* AddTaskLambdac(TString finname,Bool_t storeNtuple,Bool_t readMC,Bool_t MCPid,Bool_t realPid,Bool_t resPid,Bool_t useKF,
          ...
          const char* filterCutObjectName="LctopKpiProdCuts", const char* analysisCutObjectName="LctopKpiAnalysisCuts")
{
  //==============================================================================
  ...
  else   prodcuts = (AliRDHFCutsLctopKpi*)filecuts->Get(filterCutObjectName);
  ...
  else analysiscuts = (AliRDHFCutsLctopKpi*)filecuts->Get(analysisCutObjectName);
